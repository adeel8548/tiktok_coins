      ...
      <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border-2 border-red-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 max-w-2xl w-full relative shadow-[0_0_50px_rgba(255,0,0,0.3)] animate-in zoom-in duration-300 text-center max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-red-600/20 rounded-full flex items-center justify-center animate-pulse">
            <svg className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
        </div>

        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent mb-3">
          Thank You!
        </h2>
        ...
        <div className="bg-white/5 border border-gray-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
          <h3 className="text-base sm:text-lg font-semibold text-gray-300 mb-3 sm:mb-4">What's Next?</h3>
          <ul className="text-left space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-400">
            <li className="flex items-start gap-2 sm:gap-3">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          onClick={onClose}
          className="w-full px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transition-all duration-300 text-white"
        >
          Done
        </button>
      </div>
